...
NOTE: The file uses the Unleash https://docs.getunleash.io/api/export-features[export format].
See also the https://docs.getunleash.io/concepts/import-export[import and export] overview.
